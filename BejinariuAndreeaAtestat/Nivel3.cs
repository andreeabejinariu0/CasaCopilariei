    ...
    public partial class Nivel3 : Form
    {
        ...
        private void check_win()
            ...
            if ((cos_x > target_x && cos_x < (target_x + target_w)) && (cos_y > target_y && cos_y < (target_y + target_h)))
            {
                ...
                timer1.Stop();
                t = t / 10;
                string mesaj = "FELICITĂRI! Ai rezolvat labirintul în " + t.ToString() + " secunde" + "\nAi trecut prin toate probele, iar coșul cu bunătăți a reușit să ajungă la casa bunicii :) ";
                var result = MessageBox.Show(mesaj, "Ai câștigat!", MessageBoxButtons.OK);
        ...
        private void check_all_walls()
        {
            ...
            check_wall_collision(label17);
            check_wall_collision(label18);
            check_wall_collision(label19);
            check_wall_collision(label20);
            check_wall_collision(label21);
            check_wall_collision(label22);
            check_wall_collision(label23);
            check_wall_collision(label25);
            check_wall_collision(label26);
        }
